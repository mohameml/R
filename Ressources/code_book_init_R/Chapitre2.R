...
res
res2<-data.frame(mat,phy,row.names=c("Guillaume","Valérie","Thomas","Julie"))
res2
#page 54
getwd()
#setwd("C:\\Data")
...
library(gdata)
read.xls("table7.xls")
#Pas de données dans la feuille 2 donc erreur lors de la lecture
...
#page 83
#Exercice 2.3
nom<-c("Guillaume","Valérie","Thomas","Julie","Sébastien","Stéphanie","Grégory","Ambre",
...
age
str(age)
c("Guillaume"=66.5,"Valérie"=50.5,"Thomas"=67.5,"Julie"=52.0,"Sébastien"=83.0,
  "Stéphanie"=65.0,"Grégory"=79.0,"Ambre"=64.0,"Jean-Sébastien"=81.0,"Camille"=53.0)
