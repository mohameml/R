...
x=seq(-5,5,0.1) ;pdf=dnorm(x) ;plot(x,pdf,type="l",
  main="Densité de la loi normale centrée et réduite")
runif(10)
...
plot(0:6000,dbinom(0:6000,6000,.9331928),xlab="n",ylab="Probabilité",lwd=2)
plot(5500:5700,dbinom(5500:5700,6000,.9331928),xlab="n",ylab="Probabilité",lwd=2)
plot(5590:5610,dbinom(5590:5610,6000,.9331928),xlab="n",ylab="Probabilité",lwd=2)
